...
public class AdapterAddRelations extends RecyclerView.Adapter<AdapterAddRelations.MyViewHolder> {
	Context context;
	ArrayList<String> items;

	public AdapterAddRelations(Context context, ArrayList<String> items){
