...
public class AdapterAddDesgnations extends RecyclerView.Adapter<AdapterAddDesgnations.MyViewHolder> {
	Context context;
	ArrayList<String> items;

	public AdapterAddDesgnations(Context context, ArrayList<String> items){
