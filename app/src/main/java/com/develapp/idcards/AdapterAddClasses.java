...
public class AdapterAddClasses extends RecyclerView.Adapter<AdapterAddClasses.MyViewHolder> {
	Context context;
	ArrayList<String> items;

	public AdapterAddClasses(Context context, ArrayList<String> items){
