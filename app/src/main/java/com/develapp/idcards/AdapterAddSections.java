...
public class AdapterAddSections extends RecyclerView.Adapter<AdapterAddSections.MyViewHolder> {
	Context context;
	ArrayList<String> items;

	public AdapterAddSections(Context context, ArrayList<String> items){
